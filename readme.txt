...
1、book_name： 书名，匹配得越准确越好，程序会自动从epubee搜索并添加可能的结果（前3个，因为免费用户限每日添加3本书，所以书面越准确结果越匹配），如果不需要自动搜索添加，则book_name=""   
    
2、loc书下载后目录，最好为全路径   
   
3、email和epwd为指定切换用户的邮箱和密码，用于方便通过网站页面手工添加书后，再用程序下载，留空为不切换
